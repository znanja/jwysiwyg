		...
		this.ui.initFrame = function () {
			...
			if (self.options.xhtml5) {
				...
				self.events.bind("getContent", function (text) {
					return text.replace(/&(?:amp;)?([a-z][a-z0-9]*);/gi, function (str, p1) {
//console.log("str", str, "p1", p1);
						lcp1 = p1.toLowerCase();
						if (!replacements[p1]) {
							/* lefts leave the entities alone if they're accepted by XML and HTML */
							if (-1 !== $.inArray(p1, ["amp", "lt", "gt", "quot"])) {
								return str;
							} else if (replacements[lcp1]) {
								p1 = lcp1;
							} else {
								p1 = "__replacement";
							}
...
//console.log("&#" + dec2hex(num, leading_zeros) + ";");
